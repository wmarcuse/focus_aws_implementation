...
class ExampleConsumer(object):
    ...
    def read_dynamodb_model_record(self, scope, routing_key):
        ...
        # Retrieve all models from DynamoDB using the DynamoDB scan operation.
    ...
    def update_dynamodb_model_record(self, context):
        ...
        table = client.Table('REPMEFocusCustomTable')
        client_model_names = ['client_x_model', 'client_y_model']

        for cmn in client_model_names:
            response = table.update_item(
                Key={
                    'name': cmn
                },
                UpdateExpression="set isThisAwesome=:i",
